...
info.M0=0.01; %info.V0_range/info.S0;
info.delta_range=logspace(-2,1.6532,1000);
%info.delta_range=logspace(-2,2,100);
info.ptilde_range=logspace(-2,0,1000);

[vP,vPtilde]=meshgrid(info.delta_range,info.ptilde_range);
...
set(gca,'ytick',[-2:0.4:1.6532]);
%set(gca,'xticklabel',{'0.01';'0.1';'0.2';'0.3';'0.7';'1'});
%set(gca,'yticklabel',{'1.6';'1.2';'1';'0.1';'0.01';'0'});
% Label
%xlabel('Initial virus-host ratio, $V_0/S_0$','fontsize',20,'verticalalignment','top','interpreter','latex');
xlabel('the probability of host being dormant, $\delta$','fontsize',20,'verticalalignment','top','interpreter','latex');
%ylabel('Individual cell fate ratio, $\delta$','fontsize',20,'verticalalignment','bottom','interpreter','latex');
ylabel('the probability of host being dormant, $\tilde{p}$','fontsize',20,'verticalalignment','bottom','interpreter','latex');
title('Population dormancy enhancement, $D_{\infty}/S_0$','fontsize',20,'verticalalignment','bottom','interpreter','latex','horizontalalignment','center');
set(gca,'fontsize',20);
