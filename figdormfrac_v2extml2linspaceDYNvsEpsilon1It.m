...
tmph=plot(epsilonvec,Itvec(1,:),'r-*',epsilonvec,Itvec(2,:),'g-*',epsilonvec,Itvec(3,:),'b-*')
...
title({'Infected cell density $I(t)$','\quad\quad at $t=24,48,72$'},'fontsize',20,'verticalalignment','bottom','interpreter','latex','horizontalalignment','center');
set(gca,'fontsize',20);
