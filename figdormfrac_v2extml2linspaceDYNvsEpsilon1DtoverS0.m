...
% figure is drawn
tmpfilename = 'DYNvsEpsilonDtoverS0';
...
tmph=plot(epsilonvec,Dtvec(1,:)/S0,'r-*',epsilonvec,Dtvec(2,:)/S0,'g-*',epsilonvec,Dtvec(3,:)/S0,'b-*')
...
title({'Dormant cell density fraction $D(t)/S_0$','\qquad\qquad at $t=24,48,72$'},'fontsize',20,'verticalalignment','bottom','interpreter','latex','horizontalalignment','center');
set(gca,'fontsize',20);
