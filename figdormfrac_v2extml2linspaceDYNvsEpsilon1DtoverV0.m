...
% figure is drawn
tmpfilename = 'DYNvsEpsilonDtoverV0';
...
tmph=plot(epsilonvec,Dtvec(1,:)/V0,'r-*',epsilonvec,Dtvec(2,:)/V0,'g-*',epsilonvec,Dtvec(3,:)/V0,'b-*')
...
title({'Population dormancy enhancement $D(t)/V_0$','\qquad\qquad at $t=24,48,72$'},'fontsize',20,'verticalalignment','bottom','interpreter','latex','horizontalalignment','center');
set(gca,'fontsize',20);
