...
% figure is drawn
tmpfilename = 'DormFrac_max_vs_p_host_demography_PARTIAL';
...
set(gca,'xticklabel');
set(gca,'yticklabel');
xlabel('Clearance rate, $\gamma$','fontsize',20,'verticalalignment','top','interpreter','latex');
