function []=figdormfrac_v2extml2linspace
clf;
clear all
set(0,'DefaultTextInterpreter', 'latex')
tmpfilename = 'figdormfrac_v2extml2linspace';
...
tmpt = pwd;
clear tmp*
set(gcf, 'PaperPosition', [0 0 4 4]); %Position plot at left hand corner with width 5 and height 5.
set(gcf, 'PaperSize', [13.5 9]); %Set the paper to have width 5 and height 5.
saveas(gcf, 'figdormfrac_v2extml2linspace', 'pdf') %Save figure
