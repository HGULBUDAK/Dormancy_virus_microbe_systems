...
% figure is drawn
tmpfilename = 'FigCurve_fitting_dormancy_host_demography_no_virus_LOG';
...
%%
[paramfit,resnorm] = lsqcurvefit(@Solve_mybird,paramguess,tdat,ydat,[0.0001,ydat(end)],[0.5,10^10]);
paramfit(1)
paramfit(2)
resnorm
...
tmph=plot(t1,log10(u1),'r-',tdat,ydat,'o');
...
ylabel('Log total cell density, $log(N(t))$','fontsize',20,'verticalalignment','bottom','interpreter','latex');
